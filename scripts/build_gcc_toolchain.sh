...
# In the new layout the musl-xv6 overlay lives next to this script's
# parent (toolchain/musl-xv6), not under user/. Allow override via env
# for unusual installs.
WORKSPACE_DIR="$(cd "${SCRIPT_DIR}/.." && pwd)"
MUSL_XV6_DIR="${MUSL_XV6_DIR:-${WORKSPACE_DIR}/musl-xv6}"
